                        ...
                        script {
                            ...
                            if(currentActiveDevices.isEmpty() || currentActiveDevices.trim().isEmpty()) {
                                ...
                                try {
                                    ...
                                    sh "$ANDROID_HOME/tools/emulator -skin 1440x2560 -ports ${env.emulator1},${env.emulator1+1} -avd ${env.avd1} -no-audio -no-snapshot-load -no-snapshot-save -wipe-data -no-boot-anim -memory 2048 -cache-size 1000 -verbose"
                                } catch (Exception e) {
